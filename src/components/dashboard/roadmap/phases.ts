...
export const TASKS: TaskDef[] = [
  ...
  // Documents - shared
  {
    ...
    why: "Lenders use these to verify you have enough for the down payment and closing costs, and to check for large, unexplained deposits. Download PDF statements directly from your bank's website or app — every page, including blank ones.",
    category: "document",
  },
  {
    id: "doc_assets",
    ...
    why: "If you plan to use retirement or investment funds toward your purchase, lenders typically want the most recent quarterly or monthly statement showing the balance and account owner.",
    category: "document",
  },
  // Documents - W-2 lane
  {
    ...
    why: "Pay stubs verify your current income. Ask your employer's payroll or HR system for a PDF covering the most recent 30 days — most portals (like ADP or Workday) let you download these directly.",
    category: "document",
    appliesTo: w2Doc,
  },
  {
    ...
    why: "W-2s confirm your income history. Your employer issues these each January; you can also find past years in the same payroll portal you use for pay stubs, or from your tax preparer.",
    category: "document",
    appliesTo: w2Doc,
  },
  // Documents - self-employed lane
  {
    ...
    why: "For self-employed or contract income, lenders typically average the last two years of tax returns to determine qualifying income. Request full copies (all schedules) from your tax preparer or the IRS transcript service.",
    category: "document",
  ...
  },
  {
    ...
    why: "If you own 25% or more of a business, lenders usually want the business's returns in addition to your personal ones, to verify the business's income and stability.",
    category: "document",
    appliesTo: selfEmpDoc,
  },
  {
    ...
    why: "A year-to-date P&L bridges the gap between your last filed tax return and today. A CPA-prepared statement is generally preferred, though some lenders accept a self-prepared one.",
    category: "document",
    appliesTo: selfEmpDoc,
  },
  {
    ...
    why: "1099s document contract or freelance income from each client or platform that paid you. Gather these for the last two years — most are available for download from the payer's portal (e.g. a gig platform) by late January.",
    category: "document",
    appliesTo: selfEmpDoc,
  },
  {
    ...
    why: "If part of your funds are a gift, lenders require a signed gift letter (stating it's not a loan) plus a paper trail showing the money moving from the giver's account to yours. Your lender can provide a gift-letter template.",
    category: "document",
  },
