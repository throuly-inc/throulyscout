...
DROP POLICY IF EXISTS "Agents can delete own documents" ON public.documents;
DROP POLICY IF EXISTS "Agents can update own documents" ON public.documents;
DROP POLICY IF EXISTS "Agents can upload documents" ON public.documents;
DROP POLICY IF EXISTS "Agents can view own documents" ON public.documents;
